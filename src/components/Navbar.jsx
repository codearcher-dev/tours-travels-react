...
export default function Navbar() {
    ...
    return (
        <>
            <header
                className={`fixed left-0 right-0 z-[100] transition-all duration-500 ease-out flex justify-center ${scrolled ? "top-1" : "top-0"}`}>
                <div
            ...
            {mobileOpen && (
                <div className="fixed inset-0 z-[99] bg-paper pt-28 px-8 md:hidden">
