  ...
  return (
    <article className={`bg-white border border-line rounded-[3px] overflow-hidden transition-[transform,box-shadow,border-color] duration-350 ease-out relative hover:-translate-y-[6px] hover:-rotate-[0.4deg] hover:shadow-[0_24px_40px_rgba(18,35,46,0.14)] hover:border-transparent group reveal ${revealDelay}`}>
      <div className="h-[190px] relative overflow-hidden">
        <img src={pkg.img} alt={pkg.name} className="w-full h-full object-cover transition-transform duration-600 ease-out group-hover:scale-[1.07]" />
        <span className="absolute top-[14px] right-[14px] w-16 h-16 rounded-full border-[1.5px] border-dashed border-[rgba(247,244,238,0.9)] bg-[rgba(18,35,46,0.55)] backdrop-blur-[3px] text-white flex items-center justify-center text-center text-[9px] uppercase font-bold leading-[1.3] -rotate-[10deg]">
          {pkg.days}
          <br />
          DAYS
        </span>
