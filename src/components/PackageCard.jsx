...
export default function PackageCard({ pkg }) {
    return (
        <article
            className="group block w-full h-[400px] md:h-[500px] relative overflow-hidden"
        >
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-between p-6 md:p-8">
                ...
                <div className="flex justify-end">
                    <div className="bg-white text-ink px-5 py-2 rounded-full text-sm font-display tracking-wide shadow-xl transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="overflow-hidden h-0 group-hover:h-auto opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out mb-4">
                        <p className="text-white/80 text-sm leading-relaxed line-clamp-2 font-sans font-light">
                            {pkg.description}
                        </p>
                    </div>
